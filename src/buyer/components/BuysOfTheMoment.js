...
const item =
{
    ...
    image: 'https://structuralengineeringbasics.com/wp-content/uploads/2019/03/STRUCTURAL-ENGINEERING-MATERIALS.png'
}
                ...
                <ImageBackground source={{ uri: item.image }}
                    ...
                    <View style={styles.container}>
                        <View style={styles.subContainer}>
                            <AppText style={{ fontSize: 28, color: colors.white, fontWeight: 'bold' }}>{item.title}</AppText>
                            <AppText style={{ color: colors.primaryShade24, fontSize: 32, fontWeight: 'bold' }}>{item.subTitle}</AppText>
                            <AppText style={{ color: colors.white,fontSize: 16 }}>{item.subDetails}</AppText>
                        </View>
                    </View>
                </ImageBackground>
