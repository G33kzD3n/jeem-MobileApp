    ...
    return (
        <ImageBackground source={require('../../assets/background.png')}
            ...
            <View style={styles.firstContainer}>
                <AppText weight='bold' color={colors.white} size={42}>Log into{"\n"}your account</AppText>
            </View>
            ...
            {!showKeyboard && <View style={styles.thirdContainer}>
                <View style={styles.innerThird}>
                    ...
                    <TextClick weight='bold' textDecorationLine='underline' text='Sign Up' onClick={handleSignUp} size={16} color={colors.white} />
                </View>
            </View>}
        </ImageBackground>
    )
